...
inventario.put(television, 1);
        ...
        /*
          Para entrar al usuario Admin y asi poder añadir libros al archivo de texto es necesario que se digiten los datos del bibliotecario que implemente por predetermiado
          Nombre de usuario:Admin
          Contraseña: Biblioteca Dovali
         */
       ...
       try{
            ...
            while (opcion!=4){
                ...
                switch (opcion){
                   ...
                   case 2-> {
                        limpiarConsola(); Comprador.inicioSesion();
                    }
                    case 3->{
                        limpiarConsola();
                        Admin.iniciarSesion();
